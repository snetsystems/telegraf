			...
			output: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						"hard_cpu_limit":       int64(16),
						"hard_memory_limit":    int64(34359738368),
						"hard_cpu_request":     int64(16),
						"hard_memory_request":  int64(34359738368),
						"hard_storage_request": int64(107374182400),
						"hard_pods":            int64(110),
						"used_cpu_limit":       int64(1),
						"used_memory_limit":    int64(1610612736),
						"used_cpu_request":     int64(1),
						"used_memory_request":  int64(1610612736),
						"used_storage_request": int64(1073741824),
						"used_pods":            int64(0),
					},
					time.Unix(0, 0),
				),
