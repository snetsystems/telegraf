			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						...
						"temperature_gpu":                34,
						"temperature_gpu_max_threshold":  104,
						"temperature_gpu_slow_threshold": 101,
			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						...
						"fbc_stats_session_count":        0,
						"fan_speed":                      0,
						"gpu_current_power_limit":        170.0,
						"gpu_default_power_limit":        170.0,
						"gpu_power_draw":                 11.63,
						"gpu_power_state":                "P8",
						"memory_free":                    11806,
						"memory_total":                   12288,
						"memory_used":                    116,
						"memory_reserved":                368,
						"module_power_state":             "P8",
						"pcie_link_gen_current":          1,
						"pcie_link_rx_util":              500,
						"pcie_link_tx_util":              550,
						"pcie_link_width_current":        16,
						"performance_state":              "P8",
						"temperature_gpu":                42,
						"temperature_gpu_max_threshold":  98,
						"temperature_gpu_slow_threshold": 95,
						"temperature_gpu_target":         83,
						"utilization_gpu":                0,
						"utilization_jpeg":               0,
						"utilization_memory":             0,
			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						...
						"fbc_stats_session_count":        0,
						"fan_speed":                      0,
						"gpu_current_power_limit":        336.0,
						"gpu_default_power_limit":        320.0,
						"gpu_power_draw":                 22.78,
						"gpu_power_state":                "P8",
						"memory_free":                    8938,
						"memory_total":                   10240,
						"memory_used":                    1128,
						...
						"pcie_link_rx_util":              6000,
						"pcie_link_tx_util":              1000,
						"pcie_link_width_current":        16,
						"performance_state":              "P8",
						"temperature_gpu":                31,
						"temperature_gpu_max_threshold":  98,
			...
			expected: []telegraf.Metric{
				testutil.MustMetric(
					...
					map[string]interface{}{
						...
						"fbc_stats_average_latency":         0,
						"fbc_stats_session_count":           0,
						"gpu_current_power_limit":           500.0,
						"gpu_default_power_limit":           500.0,
						"gpu_power_draw":                    67.03,
						"gpu_power_state":                   "P0",
						"memory_free":                       80999,
						"memory_total":                      81920,
						"memory_used":                       50,
						"memory_reserved":                   869,
						"mig_mode":                          "Enabled",
						"module_power_state":                "P0",
						"pcie_link_gen_current":             4,
						"pcie_link_rx_util":                 0,
						"pcie_link_tx_util":                 4000,
						"pcie_link_width_current":           16,
						"performance_state":                 "P0",
						"serial":                            "1650522003820",
						"temperature_gpu":                   27,
						"temperature_gpu_max_mem_threshold": 95,
						"temperature_gpu_max_threshold":     92,
						"temperature_gpu_mem":               44,
						"temperature_gpu_slow_threshold":    89,
